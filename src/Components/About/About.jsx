          ...
          <div  className="row">
            <div className="col-lg-6 mt-5 text-center mb-3">
              ...
              <div className="missionContent">
                ...
                <h5 className="text-uppercase" id="headMission">our mission</h5>
              ...
              <div className="missionContent">
                ...
                <h5 className="text-uppercase" id="headMission">high touch service</h5>
                <h6 className="head6Text">
                  Superior and consistent and personal service, education and contact that anticipates and understands needs.
                </h6>
              </div>
            </div>
              ...
              {/* <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="images-carousel">
                  <div class="carousel-item">
                    <div >
                      {" "}
                      <img src={"/Images/About Us.png"} class="bottleImg" alt="..." />
                    </div>
